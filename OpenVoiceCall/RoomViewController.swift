...
class RoomViewController: UIViewController {
      let fuckHeadTest:FucKHeadTest = FucKHeadTest()
    ...
    override func viewDidLoad() {
        ...
        loadAgoraKit()
        fuckHeadTest.initPlayer();

    }

    
    @IBAction func doPlayMusicPressed(_ sender: UIButton) {
        NSLog("doPlayMusicPressed")
        fuckHeadTest.playMusicFuck();

    }
    @IBAction func doPauseMusicPressed(_ sender: UIButton) {
        NSLog("doPauseMusicPressed");
        fuckHeadTest.pauseMusicFuck();
    }
